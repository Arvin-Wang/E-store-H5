...
var pay=function(){
	...
	postData.orderAmount=document.getElementById("allmoney").value;
	...
	postData.frontURL="http://115.28.142.180:8080/EStore/e-rightcn.html";
	postData.backURL="http://115.28.142.180:8080/EStore/e-rightcn.html";
...
$(function(){
        ...
        $("#policymoney").val();
        $('#policymoney').keyup(function(){
            $('#poundage').val(($(this).val() * 0.002).toFixed(2));
            $('#allmoney').val((Number($("#policymoney").val()) + Number($("#poundage").val())).toFixed(2));
        });
...
function judge(){
           ...
           var par=/^(([1-9]\d{0,9})|0)(\.\d{1,2})?$/;
           var value=$("#policymoney").val();
           flag = par.test(value);
           if(!flag){
            layer.open({
              title: 'AllPay',
            ...
            document.getElementById("policymoney").value = "";
            document.getElementById("poundage").value = "";
            document.getElementById("allmoney").value = "";
           }
